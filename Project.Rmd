...
In this project, I will write LARS algorithm for simulated data and compare the outcomes from my codes with the ones from the lars package. Shiny apps will be used to provide an interactive interface for the users to see how each step the coefficients change by sliding a button or inputting step number. More complex interfaces may also be added as I further learn how to build Shiny apps.
